...
// MongoDB connection
mongoose.connect(`mongodb+srv://infusionwebsitescoin2:YIP9I78y2kDHoas5@cluster0.zfr72.mongodb.net/98fastbet?retryWrites=true&w=majority&appName=Cluster0`)
...
app.get('/api/name/:id', async (req, res) => {
  ...
  try {
    ...
    res.json({ username: user.username, walletBalance: wallet.balance, email: user.email,userNo:user.userNo });
  } catch (error) {
